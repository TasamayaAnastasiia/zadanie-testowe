        ...
        <section id="about" className={css.sectionThree}>
            <div className={css.container}>
                ...
                <ul className={css.listInf}>
                    <li className={css.box}>
                        <div className={css.boxInf}>
                            <img width="93" height="88" src="/src/images/diamondOne.png" alt="Beautiful image"/>
                    ...
                    <li className={css.box}>
                        <div className={css.boxInf}>
                            <img width="93" height="88" src="/src/images/diamondTwo.png" alt="Beautiful image"/>
                    ...
                    <li className={css.box}>
                        <div className={css.boxInf}>
                            <img width="93" height="88" src="/src/images/diamondThree.png" alt="Beautiful image"/>
                    ...
                    <li className={css.box}>
                        <div className={css.boxInf}>
                            <img width="93" height="88" src="/src/images/diamondFour.png" alt="Beautiful image"/>
                ...
                <div id="offer" className={css.boxDiagram}>
                    <img src="/src/images/diagram.png" alt="Diagram for result after using WordPress"/>
